...
def parse_args():
    ...
    # Dataset path
    parser.add_argument('--data_root', default='/home/maskrcnn/cocodataset', type=str,
    ...
    # MaskRcnn evaluation
    parser.add_argument('--ann_file', default='/home/maskrcnn/cocodataset/annotations/instances_val2017.json',
    ...
    parser.add_argument('--img_path', default='/home/maskrcnn/cocodataset/val2017',
                        type=str, help="File path of dataset in inference.")
    parser.add_argument('--ann_path', default='/home/maskrcnn/cocodataset/annotations/instances_val2017.json',
    ...
    # roi_align
    parser.add_argument('--roi_layer', default=dict(type='RoIAlign', out_size=7, mask_out_size=14, sample_num=2),
    ...
    parser.add_argument('--rpn_nms_num', default=1000, type=int, help="The rpn max number.")
    ...
    # cocodataset
    parser.add_argument('--mindrecord_dir', default='/home/maskrcnn/cocodataset/MindRecord_COCO', type=str,
