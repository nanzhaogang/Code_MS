...
def main(args):
    ...
    test_transform = [vision.c_transforms.CenterCrop(args.train_resize), vision.py_transforms.ToTensor()]
    ...
    cb_loss = LossMonitor(lr)
    model.train(args.end_epoch, train_dataloader, callbacks=[cb_loss, cb_savecheckpoint], dataset_sink_mode=False)
...
def parse_arguments():
    ...
    parser.add_argument('--image_path', default='./database/DIV2K', type=str)
