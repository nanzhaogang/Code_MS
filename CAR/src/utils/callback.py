    ...
    def epoch_end(self, run_context):
        ...
        if ((cur_epoch + 1) % self.eval_period) == 0:
            ...
            if m_psnr > self.m_psnr:
                self.m_psnr = m_psnr
                kgn_save_path = os.path.join(self.save_path, "kgn.ckpt")
                usn_save_path = os.path.join(self.save_path, "usn.ckpt")
                ...
                save_checkpoint(param_kgn, kgn_save_path)
                save_checkpoint(param_usn, usn_save_path)
