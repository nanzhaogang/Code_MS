...
from utils.pre_process import transform, inverse_transform_infer
...
def parse_args():
    ...
    parser.add_argument('--ckpt_file_name', default='../checkpoints/Hayao/animeganv2_generator_Hayao.ckpt')
