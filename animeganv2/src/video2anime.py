...
from utils.pre_process import preprocessing, convert_image, inverse_image
...
def parse_args():
    ...
    parser.add_argument('--video_ckpt_file_name', default='../checkpoints/Hayao/animeganv2_generator_Hayao.ckpt',
                        type=str)
