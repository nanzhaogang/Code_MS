...
class ECGCNNNet(nn.cell):
    ...
    def __init__(self,
        ...
        self.bn1 = nn.BatchNorm1d(num_features=channel_num[1])
        self.relu1 = nn.ReLU()
        ...
        self.bn2 = nn.BatchNorm1d(num_features=channel_num[3])
        self.relu2 = nn.ReLU()
        ...
        self.bn3 = nn.BatchNorm1d(num_features=channel_num[5])
        self.relu3 = nn.ReLU()
        self.max_pool3 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.flat = nn.Flatten()
        self.fc1 = nn.Dense(in_channels=600, out_channels=30)
        self.fc2 = nn.Dense(in_channels=30, out_channels=20)
        self.fc3 = nn.Dense(in_channels=20, out_channels=5)
