...
from src.model.head import ClassHead, BboxHead, LandmarkHead
from src.utils.initialize import init_kaiming_uniform
...
class RetinaFace(nn.Cell):
    ...
    Args:
        phase(string):Can be 'train' or else.If not train,classification result output will be after softmax.
            Default: 'train'.
        backbone(string):One of 'resnet50' or 'mobilenet025',backbone of RetinaFace. Default: None.
    ...
    def __init__(self, phase='train', backbone=None, cfg=None):
        ...
        if cfg is None:
            ...
            self.fpn = FPN(in_channel=cfg['in_channel'], out_channel=cfg['out_channel'])
