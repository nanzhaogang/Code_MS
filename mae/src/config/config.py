...
def common_parse_args(parser):
    ...
    parser.add_argument('--save_dir', default='./output/', type=str, help='the save dir name.')
    ...
    parser.add_argument('--use_ckpt', default='', type=str, help='the ckpt model path.')
    ...
    parser.add_argument('--eval_path', default='/data0/imagenet2012/val', type=str, help='the path of eval dataset.')
...
def train_parse_args():
    ...
    # dataset
    parser.add_argument('--data_path', default='/data0/imagenet2012', type=str, help='the path of train dataset.')
...
def finetune_parse_args():
    ...
    # dataset
    parser.add_argument('--dataset_path', default='/data0/imagenet2012/train', type=str,
